...
We have a [template repo](https://github.com/micronaut-projects/micronaut-scala) that we use as the single
...
[Release GitHub Action workflow](https://github.com/micronaut-projects/micronaut-scala/blob/master/.github/workflows/release.yml)
