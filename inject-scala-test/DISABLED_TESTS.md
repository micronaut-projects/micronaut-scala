...
Nine cases were once known gaps, each held as a `@PendingFeature` asserting what
Java does, on the reasoning that Spock fails a pending feature that passes, so
whichever was fixed would report itself rather than quietly starting to agree with
a test written around the bug. None are left. Six turned out not to be gaps at
all: the assertion, not the plugin, was wrong, most often because it asserted a
mechanism Micronaut does not use. The other three were fixed, and each of the nine
is now a plain assertion that fails if the behaviour moves.
...
- `inject-java-test/src/test/groovy/io/micronaut/inject/annotation/InheritedNullableAnnotationSpec.groovy` - covered: `ScalaAnnotationMetadataDetailParitySpec` covers a nullability annotation inherited from an abstract trait member
...
- `inject-java-test/src/test/groovy/io/micronaut/inject/visitor/InheritanceVisitorSpec.groovy` - covered: `ScalaIntrospectionGenericsParitySpec` covers members reached through a superclass and a trait, alongside `ScalaDuplicateMethodParitySpec` and `ScalaClasspathInheritanceSpec`
...
- `inject-java-test/src/test/groovy/io/micronaut/inject/visitor/beans/BeanIntrospectionGenericsSpec.groovy` - covered: `ScalaIntrospectionGenericsParitySpec` covers type arguments recorded on a generic property, on one a subclass fixes, and nested one level down
...
- `inject-java/src/test/groovy/io/micronaut/aop/adapter/intercepted/InterceptedAdapterSpec.groovy` - covered: `ScalaMappedAdviceParitySpec` covers adapter methods, covered by `ScalaAopParitySpec`, combined with stereotype-resolved advice here
...
- `inject-java/src/test/groovy/io/micronaut/aop/compile/AnnotatedConstructorArgumentSpec.groovy` - covered: `ScalaAdvisedBeanShapeParitySpec` covers a qualifier on an advised bean's constructor argument surviving into the proxy
...
- `inject-java/src/test/groovy/io/micronaut/aop/compile/AroundConstructCompileSpec.groovy` - covered: `ScalaMappedAdviceParitySpec` covers construction interception, covered by `ScalaAopParitySpec` and `ScalaLifecycleInterceptorParitySpec`
...
- `inject-java/src/test/groovy/io/micronaut/aop/compile/FinalModifierSpec.groovy` - covered: `ScalaAdviceApplicationParitySpec` covers advice refused on a final class, with the final-method diagnostic in `ScalaAopParitySpec`
- `inject-java/src/test/groovy/io/micronaut/aop/compile/GeneratedAnnotationSpec.groovy` - covered: `ScalaAdvisedBeanShapeParitySpec` covers @Generated on a written definition, read from the class file because it is CLASS retention
- `inject-java/src/test/groovy/io/micronaut/aop/compile/InheritedAnnotationMetadataSpec.groovy` - covered: `ScalaAdviceApplicationParitySpec` covers advice metadata reaching an implementation, alongside `ScalaAbstractTraitMemberAnnotationSpec` for the abstract-member case
...
- `inject-java/src/test/groovy/io/micronaut/aop/compile/IntroductionWithAroundSpec.groovy` - covered: `ScalaAdviceApplicationParitySpec` covers introduction combined with around advice, alongside `ScalaAopParitySpec`
...
- `inject-java/src/test/groovy/io/micronaut/aop/compile/OriginatingElementsSpec.groovy` - covered: `ScalaMappedAdviceParitySpec` covers a generated definition naming the bean type it was written for
...
- `inject-java/src/test/groovy/io/micronaut/aop/factory/mapped/FactoryMappedAdviceReflectionSpec.groovy` - covered: `ScalaMappedAdviceParitySpec` covers advice reaching a factory-produced bean through a stereotype
- `inject-java/src/test/groovy/io/micronaut/aop/factory/mapped/FactoryMappedAdviceSpec.groovy` - covered: `ScalaMappedAdviceParitySpec` covers advice reaching a factory-produced bean through a stereotype rather than a directly written annotation
...
- `inject-java/src/test/groovy/io/micronaut/aop/introduction/IntroductionAdviceWithNewInterfaceSpec.groovy` - covered: `ScalaAdviceApplicationParitySpec` covers a proxy implementing an interface the introduction adds that the bean never names
- `inject-java/src/test/groovy/io/micronaut/aop/introduction/MappedIntroductionOnConcreteClassSpec.groovy` - covered: `ScalaMappedAdviceParitySpec` covers advice applied from a meta-annotation on a concrete class
- `inject-java/src/test/groovy/io/micronaut/aop/introduction/MyAbstractRepoSpec.groovy` - covered: `ScalaAdviceApplicationParitySpec` covers introduction on an abstract class, alongside `ScalaIntroductionAdviceParitySpec` and `ScalaIntroductionShapeParitySpec`
...
- `inject-java/src/test/groovy/io/micronaut/aop/introduction/repeatable/IntroducedWithRepeatableAnnotationSpec.groovy` - covered: `ScalaMappedAdviceParitySpec` covers advice resolved from stereotypes, with repeatable handling in `ScalaRepeatableAnnotationParitySpec`
...
- `inject-java/src/test/groovy/io/micronaut/aop/named2/NamedAopAdviceSpec.groovy` - covered: `ScalaAdvisedBeanShapeParitySpec` covers two advised beans of one type still told apart by name
...
- `inject-java/src/test/groovy/io/micronaut/inject/aliasfor/AliasForQualifierSpec.groovy` - covered: `ScalaAliasAndVisibilityParitySpec` covers a custom qualifier written through @AliasFor, resolved by name and written onto the annotation it aliases
- `inject-java/src/test/groovy/io/micronaut/inject/annotation/AddStereotypesFromVisitorSpec.groovy` - covered: `ScalaMapperOutputParitySpec` covers stereotypes reaching the definition from a mapped annotation, alongside `ScalaElementMutationParitySpec`
- `inject-java/src/test/groovy/io/micronaut/inject/annotation/AnnotatedFieldWithSetterSpec.groovy` - covered: `ScalaAliasAndVisibilityParitySpec` covers an annotation on a member reaching the accessor pair, alongside `ScalaPropertyAnnotationRetentionSpec`
...
- `inject-java/src/test/groovy/io/micronaut/inject/annotation/AnnotationMapperSpec.groovy` - covered: `ScalaMapperOutputParitySpec` covers a mapper adding to what it reads rather than replacing it, and its output reaching the definition
...
- `inject-java/src/test/groovy/io/micronaut/inject/annotation/AnnotationRemapperSpec.groovy` - covered: `ScalaMapperOutputParitySpec` covers package remapping, covered by `ScalaAnnotationMappingParitySpec`
...
- `inject-java/src/test/groovy/io/micronaut/inject/annotation/PriorityAnnotationMapperSpec.groovy` - covered: `ScalaMapperOutputParitySpec` covers mapper output ordering within one annotation's mapped entries
...
- `inject-java/src/test/groovy/io/micronaut/inject/annotation/RetentionSpec.groovy` - covered: `ScalaAliasAndVisibilityParitySpec` covers retention deciding what survives into the class file, alongside `ScalaAnnotationMetadataDetailParitySpec` and `ScalaRetentionSpec`
...
- `inject-java/src/test/groovy/io/micronaut/inject/beans/visitor/MapperVisitorSpec.groovy` - covered: `ScalaMapperOutputParitySpec` covers a mapper running during metadata building and its output surviving the write
...
- `inject-java/src/test/groovy/io/micronaut/inject/configproperties/ConfigurationPropertiesInjectSpec.groovy` - covered: `ScalaConfigurationShapeParitySpec` covers a bean and a bound property taken through one configuration constructor
...
- `inject-java/src/test/groovy/io/micronaut/inject/configproperties/VisibilityIssuesSpec.groovy` - covered: `ScalaAliasAndVisibilityParitySpec` covers a protected member reported public because that is what Scala emits, and a private one staying private
- `inject-java/src/test/groovy/io/micronaut/inject/configproperties/eachbeaninterceptor/EachBeanInterceptorSpec.groovy` - covered: `ScalaRequiresConditionParitySpec` covers an @EachBean set resolved per configuration entry, alongside `ScalaEachPropertyParitySpec`
...
- `inject-java/src/test/groovy/io/micronaut/inject/configproperties/eachbeanreplaces/EachBeanReplacesSpec.groovy` - covered: `ScalaRequiresConditionParitySpec` covers one bean of an @EachBean set replaced by name while the others stand
...
- `inject-java/src/test/groovy/io/micronaut/inject/factory/FactoryBeanDefinitionSpec.groovy` - covered: `ScalaFactoryDefinitionParitySpec` covers the factory being a bean alongside what it produces, and each producing member carrying its own scope and qualifier
- `inject-java/src/test/groovy/io/micronaut/inject/factory/FactoryOfBeanWithUnresolvedClassSpec.groovy` - covered: `ScalaFactoryDefinitionParitySpec` covers a factory producing a type declared in the same compilation, alongside `ScalaBeanDefinitionSpec`
...
- `inject-java/src/test/groovy/io/micronaut/inject/factory/beanfield/FactoryFieldArraySpec.groovy` - covered: `ScalaValueAndProviderParitySpec` covers a factory field holding an array unpacked into one bean per element
- `inject-java/src/test/groovy/io/micronaut/inject/factory/beanmethod/FactoryBeanMethodSpec.groovy` - covered: `ScalaFactoryDefinitionParitySpec` covers a producing member resolving its own dependencies when it runs
...
- `inject-java/src/test/groovy/io/micronaut/inject/factory/collection/FactoryCollectionSpec.groovy` - covered: `ScalaBeanDefinitionSpec` covers `@Bean` and singleton factory methods returning Java and Scala collections producing one bean per element, with the qualifier separating them
...
- `inject-java/src/test/groovy/io/micronaut/inject/factory/proxytarget/FactoryWithScopedProxySpec.groovy` - covered: `ScalaFactoryDefinitionParitySpec` covers scope on a producing member, with proxy-target advice covered in `ScalaLifecycleProxyParitySpec`
...
- `inject-java/src/test/groovy/io/micronaut/inject/field/simpleinjection/FieldInjectionSpec.groovy` - covered: `ScalaFactoryDefinitionParitySpec` covers a field injected on the factory before its producers run, alongside `ScalaAutowiredSpec` and `ScalaInjectionShapeParitySpec`
...
- `inject-java/src/test/groovy/io/micronaut/inject/generics/GenericTypeArgumentsSpec.groovy` - covered: `ScalaIntrospectionGenericsParitySpec` covers type arguments a subclass fixes on a generic supertype, alongside `ScalaGenericsAndOverridesSpec` and `ScalaGenericFactoryParitySpec`
- `inject-java/src/test/groovy/io/micronaut/inject/generics/TypeArgumentsSpec.groovy` - covered: `ScalaIntrospectionGenericsParitySpec` covers type arguments on a written definition and an introspection, alongside `ScalaDefinitionGenericsParitySpec`
- `inject-java/src/test/groovy/io/micronaut/inject/inheritance/AbstractInheritanceSpec.groovy` - covered: `ScalaIntrospectionGenericsParitySpec` covers an inherited property from a generic abstract superclass, alongside `ScalaPropertyInheritanceParitySpec`
...
- `inject-java/src/test/groovy/io/micronaut/inject/property/PropertyAnnotationSpec.groovy` - covered: `ScalaValueAndProviderParitySpec` covers a property injected by name with @Property
- `inject-java/src/test/groovy/io/micronaut/inject/provider/BeanProviderSpec.groovy` - covered: `ScalaValueAndProviderParitySpec` covers deferred resolution through a BeanProvider, including one with nothing to give
- `inject-java/src/test/groovy/io/micronaut/inject/provider/DisableErrorOnMissingBeanProviderSpec.groovy` - covered: `ScalaValueAndProviderParitySpec` covers a BeanProvider for an absent bean being injectable and reporting itself empty
...
- `inject-java/src/test/groovy/io/micronaut/inject/qualifiers/replaces/AnnotateReplacesSpec.groovy` - covered: `ScalaRequiresConditionParitySpec` covers @Replaces targeting a named bean of an @EachBean set
...
- `inject-java/src/test/groovy/io/micronaut/inject/requires/RequiresSpec.groovy` - covered: `ScalaRequiresConditionParitySpec` covers a required bean present and absent, and a bean loaded only while another is missing
...
- `inject-java/src/test/groovy/io/micronaut/inject/value/factorywithvalue/FactoryWithValueSpec.groovy` - covered: `ScalaValueAndProviderParitySpec` covers @Value parameters resolved with defaults, alongside `ScalaAutowiredSpec`
...
- `inject-java/src/test/groovy/io/micronaut/visitors/ImportTypeElementSpec.groovy` - covered: `ScalaClassImportParitySpec` covers @ClassImport introspecting a type it names and annotates
...
- `inject-java/src/test/groovy/io/micronaut/visitors/MixinSpec.groovy` - covered: `ScalaClassImportParitySpec` covers @Mixin carrying its annotations onto the property of the same name on an imported type
...
- `inject-java/src/test/groovy/io/micronaut/visitors/PostponedVisitorsSpec.groovy` - scala-specific: Java annotation-processing round postponement does not map directly to Scala compiler-plugin phases; Scala visitor ordering is covered by `ScalaVisitorOrderingSpec`, while generated-bean behavior is covered by the bean builder parity tests
- `inject-java/src/test/groovy/io/micronaut/visitors/PropertyElementSpec.groovy` - candidate: partially covered by `ScalaIntrospectedPropertyParitySpec` for the conflicting-accessKind and value/name diagnostics, for an accessor pair that agrees, for a member the introspection cannot reach being reported, and for the `var` it has to be told apart from. The Jackson visibility and record cases remain comparison candidates
...
- `inject-groovy/src/test/groovy/io/micronaut/aop/compile/FinalModifierSpec.groovy` - covered: `ScalaAdviceApplicationParitySpec` covers advice refused on a final class, with the final-method diagnostic in `ScalaAopParitySpec`
- `inject-groovy/src/test/groovy/io/micronaut/aop/compile/InheritedAnnotationMetadataSpec.groovy` - covered: `ScalaAdviceApplicationParitySpec` covers advice metadata reaching an implementation, alongside `ScalaAbstractTraitMemberAnnotationSpec` for the abstract-member case
...
- `inject-groovy/src/test/groovy/io/micronaut/aop/compile/IntroductionWithAroundSpec.groovy` - covered: `ScalaAdviceApplicationParitySpec` covers introduction combined with around advice, alongside `ScalaAopParitySpec`
...
- `inject-groovy/src/test/groovy/io/micronaut/aop/compile/PropertyAdviceSpec.groovy` - covered: `ScalaAdviceApplicationParitySpec` covers advice applied to generated property accessors, on both the read and the write
...
- `inject-groovy/src/test/groovy/io/micronaut/aop/introduction/IntroductionAdviceWithNewInterfaceSpec.groovy` - covered: `ScalaAdviceApplicationParitySpec` covers a proxy implementing an interface the introduction adds that the bean never names
...
- `inject-groovy/src/test/groovy/io/micronaut/inject/aliasfor/AliasForQualifierSpec.groovy` - covered: `ScalaAliasAndVisibilityParitySpec` covers a custom qualifier written through @AliasFor, resolved by name and written onto the annotation it aliases
...
- `inject-groovy/src/test/groovy/io/micronaut/inject/annotation/RetentionSpec.groovy` - covered: `ScalaAliasAndVisibilityParitySpec` covers retention deciding what survives into the class file, alongside `ScalaAnnotationMetadataDetailParitySpec` and `ScalaRetentionSpec`
...
- `inject-groovy/src/test/groovy/io/micronaut/inject/configproperties/VisibilityIssuesSpec.groovy` - covered: `ScalaAliasAndVisibilityParitySpec` covers a protected member reported public because that is what Scala emits, and a private one staying private
...
- `inject-groovy/src/test/groovy/io/micronaut/inject/factory/FactoryBeanDefinitionSpec.groovy` - covered: `ScalaFactoryDefinitionParitySpec` covers the factory being a bean alongside what it produces, and each producing member carrying its own scope and qualifier
...
- `inject-groovy/src/test/groovy/io/micronaut/inject/factory/proxytarget/FactoryWithScopedProxySpec.groovy` - covered: `ScalaFactoryDefinitionParitySpec` covers scope on a producing member, with proxy-target advice covered in `ScalaLifecycleProxyParitySpec`
- `inject-groovy/src/test/groovy/io/micronaut/inject/generics/GenericTypeArgumentsSpec.groovy` - covered: `ScalaIntrospectionGenericsParitySpec` covers type arguments a subclass fixes on a generic supertype, alongside `ScalaGenericsAndOverridesSpec` and `ScalaGenericFactoryParitySpec`
- `inject-groovy/src/test/groovy/io/micronaut/inject/generics/TypeArgumentsSpec.groovy` - covered: `ScalaIntrospectionGenericsParitySpec` covers type arguments on a written definition and an introspection, alongside `ScalaDefinitionGenericsParitySpec`
- `inject-groovy/src/test/groovy/io/micronaut/inject/inheritance/AbstractInheritanceSpec.groovy` - covered: `ScalaIntrospectionGenericsParitySpec` covers an inherited property from a generic abstract superclass, alongside `ScalaPropertyInheritanceParitySpec`
...
- `inject-groovy/src/test/groovy/io/micronaut/inject/property/PropertyWithQualifierSpec.groovy` - covered: `ScalaValueAndProviderParitySpec` covers a property injected by name with @Property
...
- `inject-kotlin/src/test/groovy/io/micronaut/kotlin/processing/aop/introduction/MyIsEnumInTypeArgumentSpec.groovy` - covered: `ScalaAdviceApplicationParitySpec` covers introduced methods with generic return types, alongside `ScalaIntroductionGenericTypesSpec`
- `inject-kotlin/src/test/groovy/io/micronaut/kotlin/processing/aop/introduction/MyRepo3Spec.groovy` - covered: `ScalaAdviceApplicationParitySpec` covers introduction on a trait with concrete and abstract members
...
- `inject-kotlin/src/test/groovy/io/micronaut/kotlin/processing/inject/generics/GenericTypeArgumentsSpec.groovy` - covered: `ScalaIntrospectionGenericsParitySpec` covers type arguments a subclass fixes on a generic supertype, alongside `ScalaGenericsAndOverridesSpec` and `ScalaGenericFactoryParitySpec`
