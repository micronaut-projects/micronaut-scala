...
- `inject-java/src/test/groovy/io/micronaut/aop/compile/InheritedAnnotationMetadataSpec.groovy` - covered: `ScalaAdviceApplicationParitySpec` covers advice metadata reaching an implementation, alongside `ScalaAbstractTraitMemberAnnotationSpec` which marks the abstract-member case pending
...
- `inject-groovy/src/test/groovy/io/micronaut/aop/compile/InheritedAnnotationMetadataSpec.groovy` - covered: `ScalaAdviceApplicationParitySpec` covers advice metadata reaching an implementation, alongside `ScalaAbstractTraitMemberAnnotationSpec` which marks the abstract-member case pending
